...
public class SeedLowonganPengguna {
    public static void SeedLowonganPengguna() {
        try {
            ...
            connection.createStatement().executeUpdate("INSERT INTO lowongan_pengguna (idLowongan, idPengguna, status, namaLengkap, gender, asalDaerah, pendidikanTerakhir, tentangSaya) VALUES (1, 1, 'applied', 'Rizki','Laki-Laki', 'Bandung', 'S1 Teknik Informatika', 'Saya adalah seorang mahasiswa')");
