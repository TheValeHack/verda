...
public class SeedKelasBelajarQuiz {
    public static void SeedKelasBelajarQuiz() {
        try {
            ...
            connection.createStatement().executeUpdate("INSERT INTO kelas_belajar_quiz (idKelas, namaQuiz) VALUES (1, 'Quiz Wortel')");
            connection.createStatement().executeUpdate("INSERT INTO kelas_belajar_quiz (idKelas, namaQuiz) VALUES (1, 'Quiz Tomat')");
